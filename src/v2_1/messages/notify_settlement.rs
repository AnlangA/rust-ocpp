...
mod tests {
    ...
    fn test_notify_settlement_request_serialization() {
        ...
        let deserialized: NotifySettlementRequest =
    ...
    fn test_notify_settlement_response_serialization() {
        ...
        let deserialized: NotifySettlementResponse =
            serde_json::from_str(&json).expect("Failed to deserialize");
    ...
    fn test_notify_settlement_response_set_methods() {
        ...
        response
            .set_receipt_url(Some("https://example.com/receipt".to_string()))
    ...
    fn test_notify_settlement_round_trip_with_all_fields() {
        ...
        let request_deserialized: NotifySettlementRequest =
        ...
        let response_deserialized: NotifySettlementResponse =
